    ...
    <section className='pokemon-container'>
      {
        ...
        2. pokemon => <Pokemon {...pokemon} /> es un arrow function que toma un elemento del array pokemones (llamado pokemon). pokemon es el objeto actual en el array en cada iteración.

        3.<Pokemon {...pokemon} /> El operador spread (...) se usa para "expandir" un objeto. En este caso, lo que hace es tomar todas las propiedades del objeto pokemon y pasarlas como props al componente Pokemon.
